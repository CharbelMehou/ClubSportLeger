...
.overlay {
	...
	/* Utilisation de rgba pour spécifier la couleur avec une transparence */
...
.content {
	padding: 20px;
	/* Ajoutez de l'espace pour éviter que le contenu ne soit caché par la vidéo */
	color: white;
	/* Changez la couleur du texte pour qu'elle soit visible sur la vidéo */
}
</style>
</head>
<body>
