...
<body>
	...
	<div class="sub-part-navbar">
		...
		<p>DECOUVREZ TOUTE L'ACTUALITE DES CLUBS ET FEDERATIONS PROCHE DE
			CHEZ VOUS</p>
	...
	<form action="Acceuil.jsp" method="POST" id="searchForm">
		<div class="search-box">
			...
			<div class="dropdown" id="regionGroup">
				<label for="regionSelect">Région :</label> <select id="regionSelect"
			...
			<script>
				function toggleSearchType() {
					var searchType = document
							.getElementById('searchTypeSelect').value;
